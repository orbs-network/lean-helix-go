...
func TestPrepared(t *testing.T) {
	...
	t.Run("TestReturnPreparedProofWithHighestView", func(t *testing.T) {
		...
		require.Equal(t, actual.PreprepareMessage().View(), lh.View(30), "View of preprepared message should be 30 (highest for this height)")
		require.Equal(t, actual.PrepareMessages()[0].View(), lh.View(30), "View of prepared message #1 should be 30 (highest for this height)")
		require.Equal(t, actual.PrepareMessages()[1].View(), lh.View(30), "View of prepared message #2 should be 30 (highest for this height)")
	})
